# LiDAR Hillshade Explorer – User Guide (v3.2.3)
...
Version 3.2.3 for macOS is an ARM64 build for Apple Silicon MacBook Air, MacBook
...
The version 3.2.3 `.app` includes PDAL, GDAL, PROJ, and their required libraries.
