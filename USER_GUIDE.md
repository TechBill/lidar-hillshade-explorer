# LiDAR Hillshade Explorer – User Guide (v3.2.4)
...
Version 3.2.4 for macOS is an ARM64 build for Apple Silicon MacBook Air, MacBook
...
The version 3.2.4 `.app` includes PDAL, GDAL, PROJ, and their required libraries.
